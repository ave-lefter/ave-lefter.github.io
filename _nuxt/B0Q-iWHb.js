import{f as t,u as e}from"./CCEllq-w.js";import{T as s}from"./VimA5MXm.js";
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const d=c(class extends h{constructor(t){if(super(t),t.type!==a.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const r=t.element.classList;for(const s of this.st)s in e||(r.remove(s),this.st.delete(s));for(const s in e){const t=!!e[s];t===this.st.has(s)||this.nt?.has(s)||(t?(r.add(s),this.st.add(s)):(r.remove(s),this.st.delete(s)))}return s}});export{c as a,d as e,h as i,i as n,o as r,a as t};
