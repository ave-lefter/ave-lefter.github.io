import{dO as e,dR as t,bg as a,be as n,ba as s,fm as i,b9 as r,fn as o,b6 as c,bb as u,b8 as l,bi as m,b7 as d,c8 as p,bo as h,bp as w,a_ as y,b2 as g,b3 as f,dQ as x,bn as P,dP as b}from"#entry";import{r as I}from"./BmyCbnts.js";import{o as E}from"./DJ4s7H4Z.js";import{c as v}from"./DExhYf3k.js";import"./CptwCqKQ.js";import"./BbkVj9z_.js";import"./BTBR9m88.js";import"./D-6Zu1lc.js";import"./CVhMdH8L.js";import"./CnKpOVV-.js";import"./D3lBXlNu.js";import"./Ciy4IW2K.js";import"./gJ03DqDG.js";import"./CqsZNpmy.js";import"./Dh00O0bS.js";const S="INVALID_PAYMENT_CONFIG",A="INVALID_RECIPIENT",N="INVALID_ASSET",C="INVALID_AMOUNT",k="UNKNOWN_ERROR",T="UNABLE_TO_INITIATE_PAYMENT",U="INVALID_CHAIN_NAMESPACE",D="GENERIC_PAYMENT_ERROR",_="UNABLE_TO_GET_EXCHANGES",R="ASSET_NOT_SUPPORTED",O="UNABLE_TO_GET_PAY_URL",$="UNABLE_TO_GET_BUY_STATUS",M={[S]:"Invalid payment configuration",[A]:"Invalid recipient address",[N]:"Invalid asset specified",[C]:"Invalid payment amount",[k]:"Unknown payment error occurred",[T]:"Unable to initiate payment",[U]:"Invalid chain namespace",[D]:"Unable to process payment",[_]:"Unable to get exchanges",[R]:"Asset not supported by the selected exchange",[O]:"Unable to get payment URL",[$]:"Unable to get buy status"};class L extends Error{get message(){return M[this.code]}constructor(e,t){super(M[e]),this.name="AppKitPayError",this.code=e,this.details=t,Error.captureStackTrace&&Error.captureStackTrace(this,L)}}class j extends Error{}async function W(t,a){const n=`https://rpc.walletconnect.org/v1/json-rpc?projectId=${e.getSnapshot().projectId}`,{sdkType:s,sdkVersion:i,projectId:r}=e.getSnapshot(),o={jsonrpc:"2.0",id:1,method:t,params:{...a||{},st:s,sv:i,projectId:r}},c=await fetch(n,{method:"POST",body:JSON.stringify(o),headers:{"Content-Type":"application/json"}}),u=await c.json();if(u.error)throw new j(u.error.message);return u}async function Y(e){return(await W("reown_getExchanges",e)).result}const F=["eip155","solana"],H={eip155:{native:{assetNamespace:"slip44",assetReference:"60"},defaultTokenNamespace:"erc20"},solana:{native:{assetNamespace:"slip44",assetReference:"501"},defaultTokenNamespace:"token"}};function G(e,a){const{chainNamespace:n,chainId:s}=t.parseCaipNetworkId(e),i=H[n];if(!i)throw new Error(`Unsupported chain namespace for CAIP-19 formatting: ${n}`);let r=i.native.assetNamespace,o=i.native.assetReference;"native"!==a&&(r=i.defaultTokenNamespace,o=a);return`${`${n}:${s}`}/${r}:${o}`}const K="unknown",z=c({paymentAsset:{network:"eip155:1",asset:"0x0",metadata:{name:"0x0",symbol:"0x0",decimals:0}},recipient:"0x0",amount:0,isConfigured:!1,error:null,isPaymentInProgress:!1,exchanges:[],isLoading:!1,openInNewTab:!0,redirectUrl:void 0,payWithExchange:void 0,currentPayment:void 0,analyticsSet:!1,paymentId:void 0}),B={state:z,subscribe:e=>w(z,()=>e(z)),subscribeKey:(e,t)=>h(z,e,t),async handleOpenPay(e){this.resetState(),this.setPaymentConfig(e),this.subscribeEvents(),this.initializeAnalytics(),z.isConfigured=!0,u.sendEvent({type:"track",event:"PAY_MODAL_OPEN",properties:{exchanges:z.exchanges,configuration:{network:z.paymentAsset.network,asset:z.paymentAsset.asset,recipient:z.recipient,amount:z.amount}}}),await p.open({view:"Pay"})},resetState(){z.paymentAsset={network:"eip155:1",asset:"0x0",metadata:{name:"0x0",symbol:"0x0",decimals:0}},z.recipient="0x0",z.amount=0,z.isConfigured=!1,z.error=null,z.isPaymentInProgress=!1,z.isLoading=!1,z.currentPayment=void 0},setPaymentConfig(e){if(!e.paymentAsset)throw new L(S);try{z.paymentAsset=e.paymentAsset,z.recipient=e.recipient,z.amount=e.amount,z.openInNewTab=e.openInNewTab??!0,z.redirectUrl=e.redirectUrl,z.payWithExchange=e.payWithExchange,z.error=null}catch(t){throw new L(S,t.message)}},getPaymentAsset:()=>z.paymentAsset,getExchanges:()=>z.exchanges,async fetchExchanges(){try{z.isLoading=!0;const e=await Y({page:0,asset:G(z.paymentAsset.network,z.paymentAsset.asset),amount:z.amount.toString()});z.exchanges=e.exchanges.slice(0,2)}catch(e){throw l.showError(M.UNABLE_TO_GET_EXCHANGES),new L(_)}finally{z.isLoading=!1}},async getAvailableExchanges(e){try{const t=e?.asset&&e?.network?G(e.network,e.asset):void 0;return await Y({page:e?.page??0,asset:t,amount:e?.amount?.toString()})}catch(t){throw new L(_)}},async getPayUrl(e,t,a=!1){try{const n=Number(t.amount),s=await async function(e){return(await W("reown_getExchangePayUrl",e)).result}({exchangeId:e,asset:G(t.network,t.asset),amount:n.toString(),recipient:`${t.network}:${t.recipient}`});return u.sendEvent({type:"track",event:"PAY_EXCHANGE_SELECTED",properties:{source:"pay",exchange:{id:e},configuration:{network:t.network,asset:t.asset,recipient:t.recipient,amount:n},currentPayment:{type:"exchange",exchangeId:e},headless:a}}),a&&(this.initiatePayment(),u.sendEvent({type:"track",event:"PAY_INITIATED",properties:{source:"pay",paymentId:z.paymentId||K,configuration:{network:t.network,asset:t.asset,recipient:t.recipient,amount:n},currentPayment:{type:"exchange",exchangeId:e}}})),s}catch(n){if(n instanceof Error&&n.message.includes("is not supported"))throw new L(R);throw new Error(n.message)}},async openPayUrl(e,t,n=!1){try{const s=await this.getPayUrl(e.exchangeId,t,n);if(!s)throw new L(O);const i=e.openInNewTab??!0?"_blank":"_self";return a.openHref(s.url,i),s}catch(s){throw z.error=s instanceof L?s.message:M.GENERIC_PAYMENT_ERROR,new L(O)}},subscribeEvents(){z.isConfigured||(r.subscribeKey("connections",e=>{e.size>0&&this.handlePayment()}),m.subscribeKey("caipAddress",e=>{const t=r.hasAnyConnection(s.CONNECTOR_ID.WALLET_CONNECT);e&&(t?setTimeout(()=>{this.handlePayment()},100):this.handlePayment())}))},async handlePayment(){z.currentPayment={type:"wallet",status:"IN_PROGRESS"};const e=m.state.caipAddress;if(!e)return;const{chainId:c,address:u}=t.parseCaipAddress(e),d=n.state.activeChain;if(!u||!c||!d)return;if(!i.getProvider(d))return;const h=n.state.activeCaipNetwork;if(h&&!z.isPaymentInProgress)try{this.initiatePayment();const e=n.getAllRequestedCaipNetworks(),t=n.getAllApprovedCaipNetworkIds();switch(await async function(e){const{paymentAssetNetwork:t,activeCaipNetwork:s,approvedCaipNetworkIds:i,requestedCaipNetworks:r}=e,o=a.sortRequestedNetworks(i,r).find(e=>e.caipNetworkId===t);if(!o)throw new L(S);if(o.caipNetworkId===s.caipNetworkId)return;const c=n.getNetworkProp("supportsAllNetworks",o.chainNamespace);if(!i?.includes(o.caipNetworkId)&&!c)throw new L(S);try{await n.switchActiveNetwork(o)}catch(u){throw new L(D,u)}}({paymentAssetNetwork:z.paymentAsset.network,activeCaipNetwork:h,approvedCaipNetworkIds:t,requestedCaipNetworks:e}),await p.open({view:"PayLoading"}),d){case s.CHAIN.EVM:"native"===z.paymentAsset.asset&&(z.currentPayment.result=await async function(e,t,a){if(t!==s.CHAIN.EVM)throw new L(U);if(!a.fromAddress)throw new L(S,"fromAddress is required for native EVM payments.");const n="string"==typeof a.amount?parseFloat(a.amount):a.amount;if(isNaN(n))throw new L(S);const i=e.metadata?.decimals??18,o=r.parseUnits(n.toString(),i);if("bigint"!=typeof o)throw new L(D);return await r.sendTransaction({chainNamespace:t,to:a.recipient,address:a.fromAddress,value:o,data:"0x"})??void 0}(z.paymentAsset,d,{recipient:z.recipient,amount:z.amount,fromAddress:u})),z.paymentAsset.asset.startsWith("0x")&&(z.currentPayment.result=await async function(e,t){if(!t.fromAddress)throw new L(S,"fromAddress is required for ERC20 EVM payments.");const a=e.asset,n=t.recipient,i=Number(e.metadata.decimals),c=r.parseUnits(t.amount.toString(),i);if(void 0===c)throw new L(D);return await r.writeContract({fromAddress:t.fromAddress,tokenAddress:a,args:[n,c],method:"transfer",abi:o.getERC20Abi(a),chainNamespace:s.CHAIN.EVM})??void 0}(z.paymentAsset,{recipient:z.recipient,amount:z.amount,fromAddress:u})),z.currentPayment.status="SUCCESS";break;case s.CHAIN.SOLANA:z.currentPayment.result=await async function(e,t){if(e!==s.CHAIN.SOLANA)throw new L(U);if(!t.fromAddress)throw new L(S,"fromAddress is required for Solana payments.");const a="string"==typeof t.amount?parseFloat(t.amount):t.amount;if(isNaN(a)||a<=0)throw new L(S,"Invalid payment amount.");try{if(!i.getProvider(e))throw new L(D,"No Solana provider available.");const n=await r.sendTransaction({chainNamespace:s.CHAIN.SOLANA,to:t.recipient,value:a,tokenMint:t.tokenMint});if(!n)throw new L(D,"Transaction failed.");return n}catch(n){if(n instanceof L)throw n;throw new L(D,`Solana payment failed: ${n}`)}}(d,{recipient:z.recipient,amount:z.amount,fromAddress:u,tokenMint:"native"===z.paymentAsset.asset?void 0:z.paymentAsset.asset}),z.currentPayment.status="SUCCESS";break;default:throw new L(U)}}catch(w){z.error=w instanceof L?w.message:M.GENERIC_PAYMENT_ERROR,z.currentPayment.status="FAILED",l.showError(z.error)}finally{z.isPaymentInProgress=!1}},getExchangeById:e=>z.exchanges.find(t=>t.id===e),validatePayConfig(e){const{paymentAsset:t,recipient:a,amount:n}=e;if(!t)throw new L(S);if(!a)throw new L(A);if(!t.asset)throw new L(N);if(null==n||n<=0)throw new L(C)},handlePayWithWallet(){const e=m.state.caipAddress;if(!e)return void d.push("Connect");const{chainId:a,address:s}=t.parseCaipAddress(e),i=n.state.activeChain;s&&a&&i?this.handlePayment():d.push("Connect")},async handlePayWithExchange(e){try{z.currentPayment={type:"exchange",exchangeId:e};const{network:t,asset:a}=z.paymentAsset,n={network:t,asset:a,amount:z.amount,recipient:z.recipient},s=await this.getPayUrl(e,n);if(!s)throw new L(T);return z.currentPayment.sessionId=s.sessionId,z.currentPayment.status="IN_PROGRESS",z.currentPayment.exchangeId=e,this.initiatePayment(),{url:s.url,openInNewTab:z.openInNewTab}}catch(t){return z.error=t instanceof L?t.message:M.GENERIC_PAYMENT_ERROR,z.isPaymentInProgress=!1,l.showError(z.error),null}},async getBuyStatus(e,t){try{const a=await async function(e){return(await W("reown_getExchangeBuyStatus",e)).result}({sessionId:t,exchangeId:e});return"SUCCESS"!==a.status&&"FAILED"!==a.status||u.sendEvent({type:"track",event:"SUCCESS"===a.status?"PAY_SUCCESS":"PAY_ERROR",properties:{source:"pay",paymentId:z.paymentId||K,configuration:{network:z.paymentAsset.network,asset:z.paymentAsset.asset,recipient:z.recipient,amount:z.amount},currentPayment:{type:"exchange",exchangeId:z.currentPayment?.exchangeId,sessionId:z.currentPayment?.sessionId,result:a.txHash}}}),a}catch(a){throw new L($)}},async updateBuyStatus(e,t){try{const a=await this.getBuyStatus(e,t);z.currentPayment&&(z.currentPayment.status=a.status,z.currentPayment.result=a.txHash),"SUCCESS"!==a.status&&"FAILED"!==a.status||(z.isPaymentInProgress=!1)}catch(a){throw new L($)}},initiatePayment(){z.isPaymentInProgress=!0,z.paymentId=crypto.randomUUID()},initializeAnalytics(){z.analyticsSet||(z.analyticsSet=!0,this.subscribeKey("isPaymentInProgress",e=>{if(z.currentPayment?.status&&"UNKNOWN"!==z.currentPayment.status){const e={IN_PROGRESS:"PAY_INITIATED",SUCCESS:"PAY_SUCCESS",FAILED:"PAY_ERROR"}[z.currentPayment.status];u.sendEvent({type:"track",event:e,properties:{source:"pay",paymentId:z.paymentId||K,configuration:{network:z.paymentAsset.network,asset:z.paymentAsset.asset,recipient:z.recipient,amount:z.amount},currentPayment:{type:z.currentPayment.type,exchangeId:z.currentPayment.exchangeId,sessionId:z.currentPayment.sessionId,result:z.currentPayment.result}}})}}))}},V=y`
  wui-separator {
