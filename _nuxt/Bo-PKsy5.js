import{b3 as t,b4 as i,b7 as e,b8 as n}from"./DvO0AinD.js";import{n as o,a as r}from"./B_ot7u58.js";const a={getSpacingStyles:(t,i)=>Array.isArray(t)?t[i]?`var(--wui-spacing-${t[i]})`:void 0:"string"==typeof t?`var(--wui-spacing-${t})`:void 0,getFormattedDate:t=>new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(t),getHostName(t){try{return new URL(t).hostname}catch(i){return""}},getTruncateString:({string:t,charsStart:i,charsEnd:e,truncate:n})=>t.length<=i+e?t:"end"===n?`${t.substring(0,i)}...`:"start"===n?`...${t.substring(t.length-e)}`:`${t.substring(0,Math.floor(i))}...${t.substring(t.length-Math.floor(e))}`,generateAvatarColors(t){const i=t.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),e=this.hexToRgb(i),n=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),o=100-3*Number(null==n?void 0:n.replace("px","")),r=`${o}% ${o}% at 65% 40%`,a=[];for(let l=0;l<5;l+=1){const t=this.tintColor(e,.15*l);a.push(`rgb(${t[0]}, ${t[1]}, ${t[2]})`)}return`\n    --local-color-1: ${a[0]};\n    --local-color-2: ${a[1]};\n    --local-color-3: ${a[2]};\n    --local-color-4: ${a[3]};\n    --local-color-5: ${a[4]};\n    --local-radial-circle: ${r}\n   `},hexToRgb(t){const i=parseInt(t,16);return[i>>16&255,i>>8&255,255&i]},tintColor(t,i){const[e,n,o]=t;return[Math.round(e+(255-e)*i),Math.round(n+(255-n)*i),Math.round(o+(255-o)*i)]},isNumber:t=>/^[0-9]+$/u.test(t),getColorTheme(t){var i;return t||("undefined"!=typeof window&&window.matchMedia&&"function"==typeof window.matchMedia?(null==(i=window.matchMedia("(prefers-color-scheme: dark)"))?void 0:i.matches)?"dark":"light":"dark")},splitBalance(t){const i=t.split(".");return 2===i.length?[i[0],i[1]]:["0","00"]},roundNumber:(t,i,e)=>t.toString().length>=i?Number(t).toFixed(e):t};function l(t){return function(i){return"function"==typeof i?function(t,i){return customElements.get(t)||customElements.define(t,i),i}(t,i):function(t,i){const{kind:e,elements:n}=i;return{kind:e,elements:n,finisher(i){customElements.get(t)||customElements.define(t,i)}}}(t,i)}}const s=t`
  :host {
