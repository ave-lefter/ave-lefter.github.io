import{a_ as e,b2 as t,bn as i,dO as o,b7 as r,bl as s,b3 as a,bg as n,em as c,bj as l,bi as d,b9 as u,be as h,bq as p,bb as w,e3 as m,b8 as g,en as b,c8 as v,dQ as f}from"#entry";import{n as x,r as y}from"./BmyCbnts.js";import{o as C}from"./DJ4s7H4Z.js";import{c as P}from"./DExhYf3k.js";import{O as k}from"./CnUXrSB5.js";import{e as E}from"./DizDr741.js";import"./Dh00O0bS.js";import"./gJ03DqDG.js";import"./CptwCqKQ.js";import"./BbkVj9z_.js";import"./DQliy7QU.js";import"./DvnjDLz5.js";import"./CQhv4qkZ.js";import"./BEPnAQOh.js";import"./CqsZNpmy.js";import"./Dm1rYZ30.js";import"./D3lBXlNu.js";import"./CVhMdH8L.js";import"./CZyDi-Gs.js";const S=e`
  :host {
...
`;var _=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let U=class extends t{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=d.state.socialProvider,this.uri=d.state.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=o.state.remoteFeatures,this.authConnector=i.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(d.subscribeKey("farcasterUrl",e=>{e&&(this.uri=e,this.connectFarcaster())}),d.subscribeKey("socialProvider",e=>{e&&(this.socialProvider=e)}),o.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),a`${this.platformTemplate()}`}platformTemplate(){return n.isMobile()?a`${this.mobileTemplate()}`:a`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?a`${this.loadingTemplate()}`:a`${this.qrTemplate()}`}qrTemplate(){return a` <wui-flex
    ...
    >
      ...
      Copy link
    </wui-link>`}onCopyUri(){try{this.uri&&(n.copyToClopboard(this.uri),g.showSuccess("Link copied"))}catch{g.showError("Failed to copy")}}};U.styles=F,_([y()],U.prototype,"socialProvider",void 0),_([y()],U.prototype,"uri",void 0),_([y()],U.prototype,"ready",void 0),_([y()],U.prototype,"loading",void 0),_([y()],U.prototype,"remoteFeatures",void 0),U=_([P("w3m-connecting-farcaster-view")],U);export{j as W3mConnectSocialsView,U as W3mConnectingFarcasterView,A as W3mConnectingSocialView};
