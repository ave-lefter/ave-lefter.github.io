import{b3 as t,b4 as e,b5 as i,b7 as o,b8 as n,e5 as r,bc as s,bs as a,bl as l,bd as u}from"./DvO0AinD.js";import{n as p,r as c}from"./B_ot7u58.js";import{c as h,U as d}from"./Bo-PKsy5.js";import"./DUIMwiBp.js";import"./QP_KuhpX.js";const g=t`
  :host {
    position: relative;
...
`;var y,I=function(t,e,i,o){var n,r=arguments.length,s=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(s=(r<3?n(s):r>3?n(e,i,s):n(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};let T=y=class extends o{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var t;super(),this.loading=!1,this.timeoutTimeLeft=r.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=null==(t=s.state.data)?void 0:t.email,this.authConnector=a.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=Boolean(this.timeoutTimeLeft),e=this.getFooterLabels(t);return n`
      <wui-flex
