import{cx as e,gN as t,bq as o,bs as i,bh as a,bi as s,bl as r,bm as n,bC as c,bj as l,bk as d,bx as p,dQ as u,gM as h,bJ as w,bu as m,dP as g,bG as b,bB as f,br as v,gO as y,dR as k,gP as x,dS as C,bz as S,bt as N}from"#entry";import{n as T,r as A}from"./mQLjjC5r.js";import{o as E}from"./yRNs9a8f.js";import{c as O,U as P}from"./CVzBkT9j.js";import"./r7P8shUn.js";import"./Dwun3fKk.js";import"./CrwaebpX.js";import"./PZjNov0a.js";import"./DaesPtQ_.js";import"./cRykC9iU.js";import"./CnDlN4Ys.js";import"./CJyRGZno.js";import{S as $}from"./CckOrYwE.js";import"./CW7Luf7h.js";const W={isUnsupportedChainView:()=>"UnsupportedChain"===o.state.view||"SwitchNetwork"===o.state.view&&o.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void e.shake();await t.isSIWXCloseDisabled()?e.shake():("DataCapture"!==o.state.view&&"DataCaptureOtpConfirm"!==o.state.view||i.disconnect(),e.close())}},R=a`
  :host {
    display: block;
...
`;var J=function(e,t,o,i){var a,s=arguments.length,r=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(r=(s<3?a(r):s>3?a(t,o,r):a(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let Q=class extends r{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return n`
    ...
    `}templateIcon(){return this.loading?n`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:"default"===this.iconType?n`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:n`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};Q.styles=[s,F],J([T()],Q.prototype,"backgroundColor",void 0),J([T()],Q.prototype,"iconColor",void 0),J([T()],Q.prototype,"icon",void 0),J([T()],Q.prototype,"message",void 0),J([T()],Q.prototype,"loading",void 0),J([T()],Q.prototype,"iconType",void 0),Q=J([O("wui-snackbar")],Q);const Z=a`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
