import{bh as e,bl as t,bq as o,cx as r,bm as s}from"#entry";import{n as i,r as n}from"./mQLjjC5r.js";import{c as h}from"./CVzBkT9j.js";import{T as a}from"./DZlW0rpR.js";const c={interpolate(e,t,o){if(2!==e.length||2!==t.length)throw new Error("inputRange and outputRange must be an array of length 2");const r=e[0]||0,s=e[1]||0,i=t[0]||0,n=t[1]||0;return o<r?i:o>s?n:(n-i)/(s-r)*(o-r)+i}},p=e`
  :host {
    width: 100%;
    display: block;
  }
