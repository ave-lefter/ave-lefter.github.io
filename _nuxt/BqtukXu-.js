import{b3 as t,b7 as e,bj as o,b9 as i,b8 as n,bq as a,bg as s,bc as r,bn as l,bl as u,cc as c,bh as p,bi as d,b4 as h,b5 as w}from"./DvO0AinD.js";import{r as g,n as x}from"./B_ot7u58.js";import{c as k}from"./Bo-PKsy5.js";import"./knB1Rbyr.js";import"./1TgTHKeV.js";import{M as m}from"./BP3KiNyC.js";import"./Drb5iOBj.js";import{S as b}from"./IKbGZ03p.js";import"./DNhRgnSN.js";import"./CoRX4Huk.js";import"./A3Pmin_Z.js";import"./BRI2zjzy.js";import"./QP_KuhpX.js";import"./DS_txzci.js";import"./DCLEmx3U.js";import"./4RH0AGma.js";import"./BPF-pwSa.js";const f={numericInputKeyDown(t,e,o){const i=t.metaKey||t.ctrlKey,n=t.key,a=n.toLocaleLowerCase(),s=","===n,r="."===n,l=n>="0"&&n<="9";!i&&("a"===a||"c"===a||"v"===a||"x"===a)&&t.preventDefault(),"0"!==e||s||r||"0"!==n||t.preventDefault(),"0"===e&&l&&(o(n),t.preventDefault()),(s||r)&&(e||(o("0."),t.preventDefault()),((null==e?void 0:e.includes("."))||(null==e?void 0:e.includes(",")))&&t.preventDefault()),l||["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"].includes(n)||r||s||t.preventDefault()}},v=t`
  :host {
    width: 100%;
  }
...
`;var E=function(t,e,o,i){var n,a=arguments.length,s=a<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,o,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(s=(a<3?n(s):a>3?n(e,o,s):n(e,o))||s);return a>3&&s&&Object.defineProperty(e,o,s),s};let L=class extends e{constructor(){var t,e;super(),this.unsubscribe=[],this.initialParams=null==(t=r.state.data)?void 0:t.swap,this.detailsOpen=!1,this.caipAddress=l.state.caipAddress,this.caipNetworkId=null==(e=o.state.activeCaipNetwork)?void 0:e.caipNetworkId,this.initialized=b.state.initialized,this.loadingQuote=b.state.loadingQuote,this.loadingPrices=b.state.loadingPrices,this.loadingTransaction=b.state.loadingTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount,this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount,this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.inputError=b.state.inputError,this.fetchError=b.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{(null==document?void 0:document.hidden)?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{this.sourceToken&&this.toToken&&(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=u.debounce(async()=>{await b.swapTokens()},200),o.subscribeKey("activeCaipNetwork",t=>this.onCaipNetworkChange({newCaipNetwork:t,resetSwapState:!0,initializeSwapState:!1})),l.subscribeKey("caipAddress",t=>this.onCaipAddressChange({newCaipAddress:t,resetSwapState:!0,initializeSwapState:!1})),this.unsubscribe.push(o.subscribeKey("activeCaipNetwork",t=>this.onCaipNetworkChange({newCaipNetwork:t,resetSwapState:!1,initializeSwapState:!0})),l.subscribeKey("caipAddress",t=>this.onCaipAddressChange({newCaipAddress:t,resetSwapState:!1,initializeSwapState:!0})),c.subscribeKey("open",t=>{t||b.resetState()}),r.subscribeKey("view",t=>{t.includes("Swap")||b.resetValues()}),b.subscribe(t=>{this.initialized=t.initialized,this.loadingQuote=t.loadingQuote,this.loadingPrices=t.loadingPrices,this.loadingTransaction=t.loadingTransaction,this.sourceToken=t.sourceToken,this.sourceTokenAmount=t.sourceTokenAmount,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError,this.fetchError=t.fetchError,t.sourceToken&&t.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){b.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>null==t?void 0:t()),clearInterval(this.interval),null==document||document.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return n`
      <wui-flex flexDirection="column" .padding=${["0","l","l","l"]} gap="s">
        ${this.initialized?this.templateSwap():this.templateLoading()}
      </wui-flex>
    `}subscribeToVisibilityChange(){null==document||document.removeEventListener("visibilitychange",this.visibilityChangeHandler),null==document||document.addEventListener("visibilitychange",this.visibilityChangeHandler)}fetchTokensAndValues(){b.getNetworkTokenPrice(),b.getMyTokensWithBalance(),b.swapTokens(),this.lastTokenPriceUpdate=Date.now()}templateSwap(){return n`
    ...
    `}templateTokenInput(t,e){var o,a;const s=null==(o=b.state.myTokensWithBalance)?void 0:o.find(t=>(null==t?void 0:t.address)===(null==e?void 0:e.address)),r="toToken"===t?this.toTokenAmount:this.sourceTokenAmount,l="toToken"===t?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,u=i.parseLocalStringToNumber(r)*l;return n`<w3m-swap-input
      .value=${"toToken"===t?this.toTokenAmount:this.sourceTokenAmount}
      .disabled=${"toToken"===t}
      .onSetAmount=${this.handleChangeAmount.bind(this)}
      target=${t}
      .token=${e}
      .balance=${null==(a=null==s?void 0:s.quantity)?void 0:a.numeric}
    ...
    </wui-flex>`}onSwitchTokens(){b.switchTokens()}async onSwapPreview(){var t,e;this.fetchError&&await b.swapTokens(),s.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:(null==(t=this.sourceToken)?void 0:t.symbol)||"",swapToToken:(null==(e=this.toToken)?void 0:e.symbol)||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:p(o.state.activeChain)===d.ACCOUNT_TYPES.SMART_ACCOUNT}}),r.push("SwapPreview")}async handleSwapParameters(){if(this.initialParams){if(!b.state.initialized){const t=new Promise(t=>{const e=b.subscribeKey("initialized",o=>{o&&(null==e||e(),t())})});await t}await this.setSwapParameters(this.initialParams)}}async setSwapParameters({amount:t,fromToken:e,toToken:o}){if(!b.state.tokens||!b.state.myTokensWithBalance){const t=new Promise(t=>{const e=b.subscribeKey("myTokensWithBalance",o=>{o&&o.length>0&&(null==e||e(),t())});setTimeout(()=>{null==e||e(),t()},5e3)});await t}const i=[...b.state.tokens||[],...b.state.myTokensWithBalance||[]];if(e){const t=i.find(t=>t.symbol.toLowerCase()===e.toLowerCase());t&&b.setSourceToken(t)}if(o){const t=i.find(t=>t.symbol.toLowerCase()===o.toLowerCase());t&&b.setToToken(t)}t&&!isNaN(Number(t))&&b.setSourceTokenAmount(t)}onCaipAddressChange({newCaipAddress:t,resetSwapState:e,initializeSwapState:o}){this.caipAddress!==t&&(this.caipAddress=t,e&&b.resetState(),o&&b.initializeState())}onCaipNetworkChange({newCaipNetwork:t,resetSwapState:e,initializeSwapState:o}){this.caipNetworkId!==(null==t?void 0:t.caipNetworkId)&&(this.caipNetworkId=null==t?void 0:t.caipNetworkId,e&&b.resetState(),o&&b.initializeState())}};L.styles=j,E([x({type:Object})],L.prototype,"initialParams",void 0),E([g()],L.prototype,"interval",void 0),E([g()],L.prototype,"detailsOpen",void 0),E([g()],L.prototype,"caipAddress",void 0),E([g()],L.prototype,"caipNetworkId",void 0),E([g()],L.prototype,"initialized",void 0),E([g()],L.prototype,"loadingQuote",void 0),E([g()],L.prototype,"loadingPrices",void 0),E([g()],L.prototype,"loadingTransaction",void 0),E([g()],L.prototype,"sourceToken",void 0),E([g()],L.prototype,"sourceTokenAmount",void 0),E([g()],L.prototype,"sourceTokenPriceInUSD",void 0),E([g()],L.prototype,"toToken",void 0),E([g()],L.prototype,"toTokenAmount",void 0),E([g()],L.prototype,"toTokenPriceInUSD",void 0),E([g()],L.prototype,"inputError",void 0),E([g()],L.prototype,"fetchError",void 0),E([g()],L.prototype,"lastTokenPriceUpdate",void 0),L=E([k("w3m-swap-view")],L);const U=t`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var N=function(t,e,o,i){var n,a=arguments.length,s=a<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,o,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(s=(a<3?n(s):a>3?n(e,o,s):n(e,o))||s);return a>3&&s&&Object.defineProperty(e,o,s),s};let O=class extends e{constructor(){super(),this.unsubscribe=[],this.detailsOpen=!0,this.approvalTransaction=b.state.approvalTransaction,this.swapTransaction=b.state.swapTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount??"",this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount??"",this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.caipNetwork=o.state.activeCaipNetwork,this.balanceSymbol=l.state.balanceSymbol,this.inputError=b.state.inputError,this.loadingQuote=b.state.loadingQuote,this.loadingApprovalTransaction=b.state.loadingApprovalTransaction,this.loadingBuildTransaction=b.state.loadingBuildTransaction,this.loadingTransaction=b.state.loadingTransaction,this.unsubscribe.push(l.subscribeKey("balanceSymbol",t=>{this.balanceSymbol!==t&&r.goBack()}),o.subscribeKey("activeCaipNetwork",t=>{this.caipNetwork!==t&&(this.caipNetwork=t)}),b.subscribe(t=>{this.approvalTransaction=t.approvalTransaction,this.swapTransaction=t.swapTransaction,this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.sourceTokenAmount=t.sourceTokenAmount??"",this.toTokenAmount=t.toTokenAmount??"",this.inputError=t.inputError,t.inputError&&r.goBack(),this.loadingQuote=t.loadingQuote,this.loadingApprovalTransaction=t.loadingApprovalTransaction,this.loadingBuildTransaction=t.loadingBuildTransaction,this.loadingTransaction=t.loadingTransaction}))}firstUpdated(){b.getTransaction(),this.refreshTransaction()}disconnectedCallback(){this.unsubscribe.forEach(t=>null==t?void 0:t()),clearInterval(this.interval)}render(){return n`
    ...
    `}refreshTransaction(){this.interval=setInterval(()=>{b.getApprovalLoadingState()||b.getTransaction()},1e4)}templateSwap(){var t,e,o,a;const s=`${i.formatNumberToLocalString(parseFloat(this.sourceTokenAmount))} ${null==(t=this.sourceToken)?void 0:t.symbol}`,r=`${i.formatNumberToLocalString(parseFloat(this.toTokenAmount))} ${null==(e=this.toToken)?void 0:e.symbol}`,l=parseFloat(this.sourceTokenAmount)*this.sourceTokenPriceInUSD,u=parseFloat(this.toTokenAmount)*this.toTokenPriceInUSD,c=i.formatNumberToLocalString(l),p=i.formatNumberToLocalString(u),d=this.loadingQuote||this.loadingBuildTransaction||this.loadingTransaction||this.loadingApprovalTransaction;return n`
        ...
        <wui-flex class="preview-container" flexDirection="column" alignItems="flex-start" gap="l">
          ...
          >
            ...
            <wui-token-button
              flexDirection="row-reverse"
              text=${r}
              imageSrc=${null==(a=this.toToken)?void 0:a.logoUri}
            >
            </wui-token-button>
          </wui-flex>
        </wui-flex>
...
`;var K=function(t,e,o,i){var n,a=arguments.length,s=a<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,o,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(s=(a<3?n(s):a>3?n(e,o,s):n(e,o))||s);return a>3&&s&&Object.defineProperty(e,o,s),s};let M=class extends e{constructor(){var t;super(),this.unsubscribe=[],this.targetToken=null==(t=r.state.data)?void 0:t.target,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount,this.toToken=b.state.toToken,this.myTokensWithBalance=b.state.myTokensWithBalance,this.popularTokens=b.state.popularTokens,this.suggestedTokens=b.state.suggestedTokens,this.tokensLoading=b.state.tokensLoading,this.searchValue="",this.unsubscribe.push(b.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.myTokensWithBalance=t.myTokensWithBalance,this.popularTokens=t.popularTokens,this.suggestedTokens=t.suggestedTokens,this.tokensLoading=t.tokensLoading}))}async firstUpdated(){await b.getTokenList()}updated(){var t,e;const o=null==(t=this.renderRoot)?void 0:t.querySelector(".suggested-tokens-container");null==o||o.addEventListener("scroll",this.handleSuggestedTokensScroll.bind(this));const i=null==(e=this.renderRoot)?void 0:e.querySelector(".tokens");null==i||i.addEventListener("scroll",this.handleTokenListScroll.bind(this))}disconnectedCallback(){var t,e;super.disconnectedCallback();const o=null==(t=this.renderRoot)?void 0:t.querySelector(".suggested-tokens-container"),i=null==(e=this.renderRoot)?void 0:e.querySelector(".tokens");null==o||o.removeEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),null==i||i.removeEventListener("scroll",this.handleTokenListScroll.bind(this)),clearInterval(this.interval)}render(){return n`
    ...
    `}templateMyTokens(){const t=this.myTokensWithBalance?Object.values(this.myTokensWithBalance):[],e=this.filterTokensWithText(t,this.searchValue);return(null==e?void 0:e.length)>0?n`<wui-flex justifyContent="flex-start" padding="s">
          <wui-text variant="paragraph-500" color="fg-200">Your tokens</wui-text>
        </wui-flex>
        ${e.map(t=>{var e,o,i;const a=t.symbol===(null==(e=this.sourceToken)?void 0:e.symbol)||t.symbol===(null==(o=this.toToken)?void 0:o.symbol);return n`
            <wui-token-list-item
