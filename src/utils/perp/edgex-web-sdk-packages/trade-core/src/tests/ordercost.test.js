const { calculateMaxCreateOrderSize, calculateCreateOrderCost } = require("@/components/calculator/order");
const riskTierList = [
  {
    tier: 1,
...
test("test calculateCreateOrderCost", () => {
  const cost = calculateCreateOrderCost({ ...fixedParams, order: ordersToTest, orderSide: "BUY", orderPrice: "71000", orderSize: "0.141866" });
  expect(cost.toNumber()).toBe(1139.964242999999);
});
