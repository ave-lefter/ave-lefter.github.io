...
export const Four_TokenManagerHelper_V3_ABI = [
  "constructor()",
  ...
  "function sellForEth(uint256 origin, address token, address from, uint256 amount, uint256 minFunds, uint256 feeRate, address feeRecipient)",
  "function sellForEth(uint256 origin, address token, uint256 amount, uint256 minFunds)",
...
export const PopMeFun_ABI = [
  ...
  "error ZeroAddress()",
  "error ZeroAmount()",
  "event CreateToken(address indexed user, address indexed token, bytes32 tokenIdentifier, string uri, uint256 virtualBaseAmount, uint256 virtualQuoteAmount, uint256 timestamp)",
  "event Initialized(uint64 version)",
  "event LiquidityAdded(address indexed token, address indexed quote, uint256 tokenAmount, uint256 ethAmount, address pool, uint256 liquidity, uint256 timestamp)",
  "event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)",
  "event Paused(address account)",
  "event Trade(address user, address inputToken, address outputToken, uint256 inputAmount, uint256 outputAmount, uint8 inputDecimal, uint8 outputDecimal, address feeToken, uint256 feeAmount, uint256 inputReserveAmount, uint256 outputReserveAmount, uint256 price, uint64 timestamp)",
  "event TransferFee(address to, address feeToken, uint256 amount)",
  "event Unpaused(address account)",
  "function DEFAULT_ETH_TARGET() view returns (uint256)",
  "function DEFAULT_MAX_OFFERS() view returns (uint256)",
  "function DEFAULT_MAX_SUPPLY() view returns (uint256)",
  ...
  "function createToken(string _name, string _symbol, string _uri, string _salt) returns (address)",
  "function createTokenAndBuy(string _name, string _symbol, string _uri, string _salt, uint256 amount) payable returns (address)",
  "function getTokenInfo(address _token) view returns (tuple(address base, address quote, uint256 reserve0, uint256 reserve1, uint256 vReserve0, uint256 vReserve1, uint256 maxOffers, uint256 totalSupply, uint256 lastPrice, uint256 target, address creator, bool launched))",
  "function initialize(address curve_)",
  "function owner() view returns (address)",
  "function pause()",
  "function paused() view returns (bool)",
  "function predictTokenAddress(string salt) view returns (address)",
  "function proxiableUUID() view returns (bytes32)",
  "function renounceOwnership()",
  "function sellToken(address _token, uint256 _amount, uint256 _minAmountOut)",
  "function setCurveInitData(address _token, uint256 _vB, uint256 _vQ)",
  "function tokenLaunched(address) view returns (bool)",
  "function tokens(uint256) view returns (address)",
  "function tokensInfo(address) view returns (address base, address quote, uint256 reserve0, uint256 reserve1, uint256 vReserve0, uint256 vReserve1, uint256 maxOffers, uint256 totalSupply, uint256 lastPrice, uint256 target, address creator, bool launched)",
  "function transferOwnership(address newOwner)",
  ...
  "function unpause()",
  "function upgradeToAndCall(address newImplementation, bytes data) payable",
  "function uri(address _token) view returns (string)",
