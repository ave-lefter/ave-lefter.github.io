...
watch(()=>{
  ...
  return [newFilter?.[`${props.sortKey}_min`], newFilter?.[`${props.sortKey}_max`],globalStore.rankActiveTab,globalStore.rankCommon.activeInterval]
},([minVal,maxVal,newActiveTab,newInterval],[,,oldActiveTab,oldInterval])=>{
