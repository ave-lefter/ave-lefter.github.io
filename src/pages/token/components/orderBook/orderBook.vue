      ...
      <div v-loading="listStatus.loadingTxs" class="text-12px">
        ...
        <div class="grid grid-cols-[1fr_1fr_62px_30px] gap-20px mt-8px mb-4px text-12px color-[--third-text]">
          <div class="text-left flex items-center gap-2px text-nowrap">
            ...
            >
              ...
              <svg v-else width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="color-[--third-text]">
        ...
        >
          ...
          >
            ...
            <!-- Price -->
            <div class="text-right text-nowrap color-[--secondary-text]">
            ...
            <div class="text-right">
              <div class="flex items-center justify-end">
                ...
                <UserRemark
                  ...
                  class="color-[--secondary-text] truncate max-w-42px"
                  :mouseoverAddress="e => openMarkerTooltip(row, e)"
                  :canEdit="false"
                  @update-remark="updateRemark"
                />
                <!-- 添加交易次数显示 -->
                <div v-if="row.count && row.count > 1" class="color-[--secondary-text] text-xs ml-2px whitespace-nowrap">
                  ({{ row.count }})
                </div>
              </div>
            </div>
