<template>
  <div class="relative">
    ...
    <FavAddressPop
      ...
      width="248"
      :groupOptions="addressGroups"
      :title="$t('followAddress')"
      @onConfirm="handleAddAttention"
      @onCancel="() => (favAddressPopVisible = false)"
    />
...
const { addressGroups, attentionTrigger, favAddressPopVisible, handleAddAttention } =
  storeToRefs(useFollowStore())
