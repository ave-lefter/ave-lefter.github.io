    ...
    <div :style="{
      ...
      <div v-for="virtualRow in virtualItems" :key="String(virtualRow.key)" :style="{
        ...
        <div :ref="(el) => virtualizer.measureElement(el)" :data-index="virtualRow.index"
          ...
          <div v-if="['2', '3', '4','5'].includes(getItem(virtualRow).type) && virtualRow.content && (getItem(virtualRow).retweeted_tweet || getItem(virtualRow).quoted_tweet || getItem(virtualRow).replied_tweet)"
